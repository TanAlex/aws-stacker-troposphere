...
from troposphere.autoscaling import ScalingPolicy, MetricsCollection
from troposphere.cloudwatch import Alarm, MetricDimension

CLUSTER_SG_NAME = "%sSG"
ELB_SG_NAME = "%sElbSecurityGroup"
...
class AutoscalingGroup(Blueprint):
    ...
    def create_template(self):
        ...
        self.create_autoscaling_policies()
